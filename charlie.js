...
async function createTypeCollectionAndIssueCredential() {
    const apiKey = "your_api_key_here"; // Ensure this is your actual API key
    const headers = {
        "X-API-KEY": apiKey,
    ...
    // Assuming collectionResponse.json() has been awaited and collectionData contains the ID:
    const collectionId = collectionData.id; // Make sure this line accurately extracts the ID

    // Now prepare to issue the credential using the obtained collectionId
    const issueCredentialOptions = {
        ...
        body: JSON.stringify({
            ...
            recipient: "polygon:0x6C3b3225759Cbda68F96378A9F0277B4374f9F06", // Update as necessary
            credential: {
                subject: {
                    voterID: "Voter123456", // Update as necessary
                    age: "15", // Update as necessary
                    citizenship: "US", // Update as necessary
                    eligibleToVote: false, // Update as necessary
                },
                expiresAt: "2034-02-02" // Update as necessary
            }
        }),
    };
...
createTypeCollectionAndIssueCredential().catch(console.error);
